    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <div className={`flex items-center ${showText ? 'justify-between w-full px-2' : 'justify-center w-8 h-8'} py-1.5 text-left text-sm cursor-pointer hover:bg-[var(--color-american-blue)] hover:text-white rounded-md transition-colors`}>
                    <div className="flex items-center gap-2">
                        {themeIcon}
